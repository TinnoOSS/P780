...
EXPORT_SYMBOL(g_cam_info_struct);
...
EXPORT_SYMBOL(get_camera_info);

int set_camera_info(char *sensor_name, int sensor_id, int invokeSocketIdx, long SensorFullWidth, long SensorFullHeight)
{
