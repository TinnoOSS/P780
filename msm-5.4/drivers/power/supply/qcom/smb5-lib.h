...
#define DEMOMODE_VOTER		"DEMOMODE_VOTER"			//pony.ma for demomode date20210420
#define CHG_NODE_VOTER		"CHG_NODE_VOTER"			//pony.ma for demomode date20210420
#endif
#ifdef CONFIG_SCC_SUPPORT
#define SPEED_DAEMON_VOTER		"SPEED_DAEMON_VOTER"			//pony.ma for scc date20210420
#endif
...
#define THERMAL_ICL_MAX_VOTER		"THERMAL_ICL_MAX_VOTER"		//zhang.chao add for usb current limit
